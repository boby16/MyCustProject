...
namespace QRCodePrintTSB
{
    public class ToShiBaLIB_DLL
    {
        ...
        public static void BoxPrintNew(BoxVO boxVo)
        {
            ...
            str.Append("{PC000;0730,0080,20,20,e,00,B,J0101=ROHS|}").Append('\n');

            str.Append("{LC;0880,0050,0950,0100,1,3,000|}").Append('\n');//方框
            str.Append("{PC000;0900,0080,20,20,e,00,B,J0101=HF|}").Append('\n');
            ...
            str.Append("{XB00;0750,0650,T,M,09,A,0,M1,K8=" + qrCode + "|}").Append('\n');//二维码
