			...
			foreach (SurveyDetail surveyDetail in this.oQuestion.QCircleDetails)
			{
				...
				foreach (SurveyDetail surveyDetail2 in this.oQuestion.QDetails)
				{
					...
					if (surveyDetail2.IS_OTHER == 2)
					{
						...
						if (surveyDetail2.EXTEND_2 != "" && this.oBoldTitle.ParaToList(surveyDetail2.EXTEND_2, "//").Contains(code))
						{
					...
					{
						if (surveyDetail2.EXTEND_3 != "" && this.oBoldTitle.ParaToList(surveyDetail2.EXTEND_3, "//").Contains(code))
						{
							button.Visibility = Visibility.Hidden;
						}
					}
