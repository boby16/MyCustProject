...
{
	public class P_RankBrand : Page, IComponentConnector
	{
		[Serializable]
		[CompilerGenerated]
		...
		internal RowDefinition BrandArea;
		...
		private void _003F80_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			((P_RankBrand)/*Error near IL_0a58: Stack underflow*/).Text_Width = (int)/*Error near IL_0a58: Stack underflow*/;
		...
		private void _003F99_003F(object _003F347_003F, EventArgs _003F348_003F)
		{
			...
			if (PageLoaded)
			{
				...
				if (Button_Type != 0)
				{
					...
					((WrapPanel)/*Error near IL_006e: Stack underflow*/).Orientation = Orientation.Vertical;
				}
				else
				{
					ScrollViewer scrollmain2 = scrollmain;
					if (((ScrollViewer)/*Error near IL_0032: Stack underflow*/).ComputedVerticalScrollBarVisibility == Visibility.Collapsed)
					{
						wrapPanel.Orientation = Orientation.Vertical;
						((P_RankBrand)/*Error near IL_003e: Stack underflow*/).Button_Type = 2;
					}
					else
					{
				...
				if (oQuestion.QDefine.CONTROL_TOOLTIP.Trim() != _003F487_003F._003F488_003F(""))
				{
					...
					string cONTROL_TOOLTIP = ((SurveyDefine)/*Error near IL_009c: Stack underflow*/).CONTROL_TOOLTIP;
					int num = ((P_RankBrand)/*Error near IL_00a1: Stack underflow*/)._003F96_003F(cONTROL_TOOLTIP);
					if (num == 1)
					{
						RowDefinition brandArea = BrandArea;
						GridLength auto = GridLength.Auto;
						((RowDefinition)/*Error near IL_00b3: Stack underflow*/).Height = auto;
					}
					else if (num > 1)
					{
						BrandArea.Height = new GridLength((double)num);
					}
				}
		...
		private void _003F152_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			for (; num < btnOrders.Count; num++)
			{
				if (oQuestion.SelectedCode[num] != _003F487_003F._003F488_003F(""))
				{
					...
					string key = oQuestion.SelectedCode[num];
					((Dictionary<string, Button>)/*Error near IL_00aa: Stack underflow*/)[key].Style = style;
				...
				if (num > nCurrent)
				{
					List<Button> btnOrder = btnOrders;
					((List<Button>)/*Error near IL_011a: Stack underflow*/)[num].Style = style;
					txtOrders[num].Foreground = foreground;
				}
			}
			return;
		...
		private void _003F89_003F(List<VEAnswer> _003F370_003F)
		{
			...
			if (oQuestion.QCircleDefine.PAGE_COUNT_DOWN > 0)
			{
				...
				((PageNav)/*Error near IL_0078: Stack underflow*/).PageDataLog(pAGE_COUNT_DOWN, _003F370_003F, _003F431_003F, mySurveyId);
			}
		}
		...
		private void _003F58_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			if (_003F87_003F())
			{
				...
				string content = ((P_RankBrand)/*Error near IL_0040: Stack underflow*/).btnNav_Content;
		...
		public void InitializeComponent()
		{
			...
			IL_001b:
			_contentLoaded = true;
			Uri resourceLocator = new Uri(_003F487_003F._003F488_003F("\u0005Ůɛ\u0354џԋ٧\u0742ࡒ\u0948ਛ\u0b7c\u0c71൰\u0e6c\u0f74\u1074ᅼቶ፣ᐹᕣᙽ\u1776ᡥ\u193e\u1a60᭐\u1c7cᵬṢὠ\u2068ⅻ≩⍩③┫♼❢⡯⥭"), UriKind.Relative);
		...
		void IComponentConnector.Connect(int _003F349_003F, object _003F350_003F)
		{
			...
			{
			case 1:
				((P_RankBrand)_003F350_003F).Loaded += _003F80_003F;
				((P_RankBrand)_003F350_003F).LayoutUpdated += _003F99_003F;
				break;
			case 2:
			...
			case 3:
				...
				break;
			case 4:
				BrandArea = (RowDefinition)_003F350_003F;
				break;
			case 5:
