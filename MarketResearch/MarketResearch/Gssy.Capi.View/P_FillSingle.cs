...
{
	public class P_FillSingle : Page, IComponentConnector
	{
		[Serializable]
		[CompilerGenerated]
		...
		private void _003F80_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			//IL_0d1b: Incompatible stack heights: 0 vs 2
			//IL_0d32: Incompatible stack heights: 0 vs 1
			//IL_0e4c: Incompatible stack heights: 0 vs 1
			//IL_0e6b: Incompatible stack heights: 0 vs 1
			//IL_0e70: Incompatible stack heights: 0 vs 1
			//IL_0ec8: Incompatible stack heights: 0 vs 1
			//IL_0ee7: Incompatible stack heights: 0 vs 1
			//IL_0eec: Incompatible stack heights: 0 vs 1
			...
			if (oQSingle.QDefine.LIMIT_LOGIC != _003F487_003F._003F488_003F(""))
			{
				...
				((List<SurveyDetail>)/*Error near IL_0d37: Stack underflow*/).Sort((Comparison<SurveyDetail>)/*Error near IL_0d37: Stack underflow*/);
			...
			((P_FillSingle)/*Error near IL_0e75: Stack underflow*/).Button_FontSize = (int)/*Error near IL_0e75: Stack underflow*/;
			...
			((P_FillSingle)/*Error near IL_0ef1: Stack underflow*/).Button_Height = (int)/*Error near IL_0ef1: Stack underflow*/;
			...
			if (SurveyHelper.AutoFill)
			{
				...
				txtFill.Text = autoFill.Fill(oQFill.QDefine);
		...
		private void _003F99_003F(object _003F347_003F, EventArgs _003F348_003F)
		{
			...
			ScrollViewer scrollViewer = ((P_FillSingle)/*Error near IL_0029: Stack underflow*/).scrollNote;
			if (Button_Type < -20)
			{
			...
			else
			{
				...
				{
					((P_FillSingle)/*Error near IL_012b: Stack underflow*/).Button_Type = 4;
					PageLoaded = false;
				}
			}
			goto IL_02f6;
		...
		private void _003F86_003F(object _003F347_003F, KeyEventArgs _003F348_003F)
		{
			...
			if (_003F348_003F.Key == Key.Return)
			{
				...
				{
					((P_FillSingle)/*Error near IL_001c: Stack underflow*/)._003F58_003F((object)/*Error near IL_001c: Stack underflow*/, (RoutedEventArgs)_003F348_003F);
				}
			}
		}
		...
		{
			//IL_00c6: Incompatible stack heights: 0 vs 3
			...
			if (array[0].AddedLength > 0)
			{
				...
				if (flag)
				{
					...
					string text = ((string)/*Error near IL_00d1: Stack underflow*/).Remove((int)/*Error near IL_00d1: Stack underflow*/, addedLength);
		...
		private bool _003F87_003F()
		{
			...
			if (text == _003F487_003F._003F488_003F(""))
			{
				...
				MessageBox.Show((string)/*Error near IL_0053: Stack underflow*/, (string)/*Error near IL_0053: Stack underflow*/, MessageBoxButton.OK, MessageBoxImage.Hand);
				txtFill.Focus();
				return true;
			}
			text = oQFill.ConvertText(text, oQFill.QDefine.CONTROL_MASK);
			txtFill.Text = text;
		...
		private void _003F58_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			{
				Button btnNav2 = btnNav;
				string content = ((P_FillSingle)/*Error near IL_0040: Stack underflow*/).btnNav_Content;
		...
		public void InitializeComponent()
		{
			...
			IL_001b:
			_contentLoaded = true;
			Uri resourceLocator = new Uri(_003F487_003F._003F488_003F("\u0004ŭɚ\u035bўԈ٦\u0745ࡓ\u094bਚ\u0b43\u0c70൳\u0e6d\u0f73ၵᅿቷ፬ᐸᕠᙼ\u1771ᡤ\u193d\u1a61\u1b4fᱩ\u1d67ṡὠ⁸Ⅳ≧⍯⑫╣☫❼⡢⥯⩭"), UriKind.Relative);
		...
		void IComponentConnector.Connect(int _003F349_003F, object _003F350_003F)
		{
			...
			{
			case 1:
				((P_FillSingle)_003F350_003F).Loaded += _003F80_003F;
				((P_FillSingle)_003F350_003F).LayoutUpdated += _003F99_003F;
				break;
			case 2:
