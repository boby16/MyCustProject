...
{
	public class GridMultiple_LoopR_FixCol1 : Page, IComponentConnector
	{
		[Serializable]
		[CompilerGenerated]
		...
		public GridMultiple_LoopR_FixCol1()
		{
			InitializeComponent();
		}
		...
		private void _003F80_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			if (Button_Width < 2.0)
			{
				...
				Button_Width = (num6 - (double)((oQuestion.QDetails.Count - 1) * 4) - 43.0) / (double)oQuestion.QDetails.Count;
		...
		private void _003F28_003F()
		{
			...
			//IL_06af: Incompatible stack heights: 0 vs 1
			//IL_06b0: Incompatible stack heights: 0 vs 1
			//IL_08ea: Incompatible stack heights: 0 vs 1
			//IL_08fb: Incompatible stack heights: 0 vs 1
			//IL_08fd: Incompatible stack heights: 0 vs 1
			//IL_0d4a: Incompatible stack heights: 0 vs 1
			//IL_0d54: Incompatible stack heights: 0 vs 1
			//IL_0de9: Incompatible stack heights: 0 vs 1
			//IL_0df3: Incompatible stack heights: 0 vs 1
			//IL_0ebf: Incompatible stack heights: 0 vs 1
			//IL_0ec9: Incompatible stack heights: 0 vs 1
			//IL_110e: Incompatible stack heights: 0 vs 1
			//IL_111e: Incompatible stack heights: 0 vs 1
			//IL_111f: Incompatible stack heights: 0 vs 1
			...
			try
			{
				while (enumerator.MoveNext())
				{
					...
					if (oQuestion.QCircleDefine.CONTROL_TYPE == 1)
					{
						bool flag5 = oQuestion.QCircleDefine.PARENT_CODE != _003F487_003F._003F488_003F("");
					}
					bool flag2 = (byte)/*Error near IL_06b2: Stack underflow*/ != 0;
					...
					if ((oQuestion.QCircleDefine.CONTROL_TYPE != 1) | flag2)
					{
						...
						else
						{
							...
							((TextBlock)/*Error near IL_0902: Stack underflow*/).Text = (string)/*Error near IL_0902: Stack underflow*/;
								...
								while (enumerator3.MoveNext())
								{
									...
									if (list.Contains(current5.CODE))
									{
										...
										if (CodeOfGroupNone.Contains(_003F487_003F._003F488_003F(".") + current5.IS_OTHER.ToString() + _003F487_003F._003F488_003F(".")))
										{
											...
											string str3 = (string)/*Error near IL_0d56: Stack underflow*/;
										...
										if (!CodeOfNone.Contains(_003F487_003F._003F488_003F(".") + current5.IS_OTHER.ToString() + _003F487_003F._003F488_003F(".")))
										{
											...
											string str4 = (string)/*Error near IL_0df5: Stack underflow*/;
					...
					try
					{
						while (enumerator3.MoveNext())
						{
							...
							string text5 = (string)/*Error near IL_0ecb: Stack underflow*/;
							...
							((FrameworkElement)/*Error near IL_1124: Stack underflow*/).Style = (Style)/*Error near IL_1124: Stack underflow*/;
							if (flag)
							{
								button.Opacity = 0.85;
							}
		...
		private bool _003F87_003F()
		{
			...
			{
				if (selectedCode.Answers.Count == 0 && GridBottomRight.RowDefinitions[num].ActualHeight > 3.0)
				{
				...
				if (oQuestion.QDefine.MIN_COUNT != 0 && GridBottomRight.RowDefinitions[num].ActualHeight > 3.0 && selectedCode.Answers.Count < oQuestion.QDefine.MIN_COUNT)
				{
		...
		private void _003F58_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			if (_003F87_003F())
			{
				...
				string content = ((GridMultiple_LoopR_FixCol1)/*Error near IL_004b: Stack underflow*/).btnNav_Content;
		...
		public void InitializeComponent()
		{
			...
			IL_000b:
			_contentLoaded = true;
			Uri resourceLocator = new Uri(_003F487_003F._003F488_003F("\u0016ſɄ\u0345ьԚ\u0670ݓࡁख़ਔ\u0b4d\u0c42\u0d41๛ཅ၇ᅍ\u1249ፒᐊᕒᙊᝇᡖᤏ\u1a78\u1b6cᱴ\u1d78ṶὯ⁵Ⅼ≾⍦⑹╱♌❾⡾⥿⩿⭼ⱒ\u2d6a\u2e62⽲なㅧ㉫㌷㐫㕼㙢㝯㡭"), UriKind.Relative);
		...
		void IComponentConnector.Connect(int _003F349_003F, object _003F350_003F)
		{
			...
			{
			case 1:
				((GridMultiple_LoopR_FixCol1)_003F350_003F).Loaded += _003F80_003F;
				((GridMultiple_LoopR_FixCol1)_003F350_003F).LayoutUpdated += _003F99_003F;
				break;
			case 2:
