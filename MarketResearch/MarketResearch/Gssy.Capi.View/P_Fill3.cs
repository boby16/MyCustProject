...
{
	public class P_Fill3 : Page, IComponentConnector
	{
		[Serializable]
		[CompilerGenerated]
		...
		private void _003F99_003F(object _003F347_003F, EventArgs _003F348_003F)
		{
			...
			else
			{
				...
				((P_Fill3)/*Error near IL_0028: Stack underflow*/).Button_Type = 2;
			}
			goto IL_00a9;
			IL_00a3:
			goto IL_00a4;
		...
		private void _003F28_003F()
		{
			...
			foreach (SurveyDetail qDetail in oQuestion.QDetails)
			{
				...
				button.Style = style;
				button.Tag = qDetail.EXTEND_1 + _003F487_003F._003F488_003F("\u007f") + qDetail.EXTEND_2 + _003F487_003F._003F488_003F("#\ufe0fȡ") + qDetail.EXTEND_3;
		...
		private void _003F29_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			List<string> list = oBoldTitle.ParaToList((string)button.Tag, _003F487_003F._003F488_003F("#\ufe0fȡ"));
			string text = list[0];
			if (list.Count <= 1)
			{
				_003F487_003F._003F488_003F("");
		...
		private void _003F86_003F(object _003F347_003F, KeyEventArgs _003F348_003F)
		{
			...
			if (_003F348_003F.Key == Key.Return)
			{
				...
				{
					((P_Fill3)/*Error near IL_001c: Stack underflow*/)._003F58_003F((object)/*Error near IL_001c: Stack underflow*/, (RoutedEventArgs)_003F348_003F);
				}
			}
		}
		...
		private bool _003F87_003F()
		{
			...
			//IL_0166: Incompatible stack heights: 0 vs 3
			//IL_0180: Incompatible stack heights: 0 vs 1
			//IL_019e: Incompatible stack heights: 0 vs 1
			string text = txtFill1.Text;
			if (txtFill1.IsEnabled)
			{
				string b = _003F487_003F._003F488_003F((string)/*Error near IL_0021: Stack underflow*/);
				if ((string)/*Error near IL_0026: Stack underflow*/ == b)
				{
			...
			if (txtFill2.IsEnabled)
			{
				...
				if ((int)/*Error near IL_0156: Stack underflow*/ != 0)
				{
					string msgNotFill2 = SurveyMsg.MsgNotFill;
					string msgCaption2 = SurveyMsg.MsgCaption;
					MessageBox.Show((string)/*Error near IL_009f: Stack underflow*/, (string)/*Error near IL_009f: Stack underflow*/, (MessageBoxButton)/*Error near IL_009f: Stack underflow*/, MessageBoxImage.Hand);
					txtFill2.Focus();
					return true;
				}
			...
			{
				bool flag2 = text == _003F487_003F._003F488_003F("");
				if ((int)/*Error near IL_0185: Stack underflow*/ != 0)
				{
					MessageBox.Show(SurveyMsg.MsgNotFill, SurveyMsg.MsgCaption, MessageBoxButton.OK, MessageBoxImage.Hand);
					((P_Fill3)/*Error near IL_0109: Stack underflow*/).txtFill3.Focus();
					return true;
				}
				text = oQFill3.ConvertText(text, oQFill3.QDefine.CONTROL_MASK);
				txtFill3.Text = text;
			}
		...
		private void _003F58_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			{
				Button btnNav2 = btnNav;
				string content = ((P_Fill3)/*Error near IL_0040: Stack underflow*/).btnNav_Content;
		...
		void IComponentConnector.Connect(int _003F349_003F, object _003F350_003F)
		{
			...
			{
			case 1:
				((P_Fill3)_003F350_003F).Loaded += _003F80_003F;
				((P_Fill3)_003F350_003F).LayoutUpdated += _003F99_003F;
				break;
			case 2:
