...
{
	public class GridSingle_LoopR_FixRow1 : Page, IComponentConnector
	{
		[Serializable]
		[CompilerGenerated]
		...
		private void _003F99_003F(object _003F347_003F, EventArgs _003F348_003F)
		{
			...
			//IL_0437: Incompatible stack heights: 0 vs 1
					...
					try
					{
						while (enumerator.MoveNext())
						{
							...
							else
							{
								...
								Thickness borderThickness = new Thickness((double)/*Error near IL_03cc: Stack underflow*/);
								((Border)/*Error near IL_03d6: Stack underflow*/).BorderThickness = borderThickness;
								...
								((TextBlock)/*Error near IL_0454: Stack underflow*/).Text = (string)/*Error near IL_0454: Stack underflow*/;
								textBlock.Style = (Style)FindResource(_003F487_003F._003F488_003F("Qžɾͻѫգٸ\u0746\u086f७\u0a61୲౫\u0d56\u0e70\u0f7aၮᅤ"));
								textBlock.Foreground = (Brush)FindResource(_003F487_003F._003F488_003F("\\Źɯ\u037aѻբ٢\u0747\u0876ॶ\u0a71୩"));
								textBlock.TextWrapping = TextWrapping.Wrap;
		...
		private void _003F89_003F(List<VEAnswer> _003F370_003F)
		{
			...
			{
				((GridSingle_LoopR_FixRow1)/*Error near IL_003c: Stack underflow*/).oPageNav.PageDataLog(oQuestion.QDefine.PAGE_COUNT_DOWN, _003F370_003F, btnNav, MySurveyId);
			}
		}
		...
		private void _003F84_003F(object _003F347_003F, EventArgs _003F348_003F)
		{
			...
			{
				((GridSingle_LoopR_FixRow1)/*Error near IL_0010: Stack underflow*/).timer.Stop();
		...
		public void InitializeComponent()
		{
			...
			IL_000b:
			_contentLoaded = true;
			Uri resourceLocator = new Uri(_003F487_003F._003F488_003F("\u0018űɆ\u0347ъԜٲݑ\u085f\u0947ਖ\u0b4f\u0c44\u0d47๙ཇ၉ᅃቋፐᐌᕔᙈᝅᡨ\u1931\u1a7a\u1b6eᱲᵾṪά⁹ⅱ≹⍱\u244c╾♾❿⡿⥼⩒⭪Ɫ\u2d72\u2e7b⽧ばㄷ㈫㍼㑢㕯㙭"), UriKind.Relative);
		...
		void IComponentConnector.Connect(int _003F349_003F, object _003F350_003F)
		{
			...
			{
			case 1:
				((GridSingle_LoopR_FixRow1)_003F350_003F).Loaded += _003F80_003F;
				((GridSingle_LoopR_FixRow1)_003F350_003F).LayoutUpdated += _003F99_003F;
				break;
			case 2:
