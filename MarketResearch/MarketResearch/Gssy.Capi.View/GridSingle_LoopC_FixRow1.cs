...
{
	public class GridSingle_LoopC_FixRow1 : Page, IComponentConnector
	{
		[Serializable]
		[CompilerGenerated]
		...
		{
			//IL_045a: Incompatible stack heights: 0 vs 1
			//IL_045b: Incompatible stack heights: 0 vs 1
			//IL_05cc: Incompatible stack heights: 0 vs 1
			//IL_05dc: Incompatible stack heights: 0 vs 1
			//IL_05dd: Incompatible stack heights: 0 vs 1
			//IL_06c2: Incompatible stack heights: 0 vs 1
			//IL_06d3: Incompatible stack heights: 0 vs 1
			//IL_06d5: Incompatible stack heights: 0 vs 1
			//IL_0b59: Incompatible stack heights: 0 vs 1
			//IL_0b69: Incompatible stack heights: 0 vs 1
			...
			foreach (SurveyDetail qCircleDetail in oQuestion.QCircleDetails)
			{
				...
				bool flag2 = (byte)/*Error near IL_045d: Stack underflow*/ != 0;
				List<SurveyDetail>.Enumerator enumerator2;
				if ((oQuestion.QCircleDefine.CONTROL_TYPE != 1) | flag2)
				{
					...
					else
					{
						...
						Thickness borderThickness = new Thickness((double)/*Error near IL_05de: Stack underflow*/);
						((Border)/*Error near IL_05e8: Stack underflow*/).BorderThickness = borderThickness;
						...
						((TextBlock)/*Error near IL_06da: Stack underflow*/).Text = (string)/*Error near IL_06da: Stack underflow*/;
				...
				try
				{
					while (enumerator2.MoveNext())
					{
						...
						((FrameworkElement)/*Error near IL_0b6f: Stack underflow*/).Style = (Style)/*Error near IL_0b6f: Stack underflow*/;
						if (flag)
						{
							button.Opacity = 0.85;
						}
		...
		private void _003F89_003F(List<VEAnswer> _003F370_003F)
		{
			...
			{
				((GridSingle_LoopC_FixRow1)/*Error near IL_003c: Stack underflow*/).oPageNav.PageDataLog(oQuestion.QDefine.PAGE_COUNT_DOWN, _003F370_003F, btnNav, MySurveyId);
			}
		}
		...
		private void _003F84_003F(object _003F347_003F, EventArgs _003F348_003F)
		{
			...
			{
				((GridSingle_LoopC_FixRow1)/*Error near IL_0010: Stack underflow*/).timer.Stop();
		...
		void IComponentConnector.Connect(int _003F349_003F, object _003F350_003F)
		{
			...
			{
			case 1:
				((GridSingle_LoopC_FixRow1)_003F350_003F).Loaded += _003F80_003F;
				((GridSingle_LoopC_FixRow1)_003F350_003F).LayoutUpdated += _003F99_003F;
				break;
			case 2:
