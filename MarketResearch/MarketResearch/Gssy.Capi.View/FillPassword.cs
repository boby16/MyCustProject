...
{
	public class FillPassword : Page, IComponentConnector
	{
		[Serializable]
		[CompilerGenerated]
		...
		private void _003F80_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			{
				txtFill.Password = oLogicEngine.stringResult(oQuestion.QDefine.PRESET_LOGIC);
				txtFill.SelectAll();
			}
			txtFill.Focus();
			...
			if (SurveyHelper.AutoFill)
			{
				...
				if (txtFill.Password == _003F487_003F._003F488_003F(""))
				{
					txtFill.Password = autoFill.Fill(oQuestion.QDefine);
				}
			...
			if (!(navOperation == _003F487_003F._003F488_003F("FŢɡ\u036a")))
			{
				...
				else if (oQuestion.QDefine.EXTEND_1.Contains(SurveyHelper.Only1CodeMode3) && txtFill.Password != _003F487_003F._003F488_003F("") && !SurveyHelper.AutoFill)
				{
					_003F58_003F(this, _003F348_003F);
				}
			}
			...
			{
				txtFill.Password = oQuestion.ReadAnswerByQuestionName(MySurveyId, oQuestion.QuestionName);
			}
		...
		private void _003F29_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			if ((int)obj.Tag == 0)
			{
				string password2 = txtFill.Password;
				if (((string)/*Error near IL_0027: Stack underflow*/).IndexOf(text) == -1)
				{
					PasswordBox txtFill2 = txtFill;
					string password = ((PasswordBox)/*Error near IL_002d: Stack underflow*/).Password + text;
					((PasswordBox)/*Error near IL_003e: Stack underflow*/).Password = password;
				}
			}
			else
			{
				txtFill.Password = text;
			}
			txtFill.Focus();
		}
		...
		private void _003F86_003F(object _003F347_003F, KeyEventArgs _003F348_003F)
		{
			...
			if (_003F348_003F.Key == Key.Return)
			{
				...
				{
					((FillPassword)/*Error near IL_0017: Stack underflow*/)._003F58_003F((object)/*Error near IL_0017: Stack underflow*/, (RoutedEventArgs)_003F348_003F);
				}
			}
		}
		...
		private bool _003F87_003F()
		{
			...
			string text = txtFill.Password.Trim();
		...
		public void InitializeComponent()
		{
			...
			IL_001b:
			_contentLoaded = true;
			Uri resourceLocator = new Uri(_003F487_003F._003F488_003F("\u0004ŭɚ\u035bўԈ٦\u0745ࡓ\u094bਚ\u0b43\u0c70൳\u0e6d\u0f73ၵᅿቷ፬ᐸᕠᙼ\u1771ᡤ\u193d\u1a77᭹ᱣ\u1d62ṽὭ⁸ⅹ≾⍧⑵╢☫❼⡢⥯⩭"), UriKind.Relative);
		...
		void IComponentConnector.Connect(int _003F349_003F, object _003F350_003F)
		{
			...
			{
			case 1:
				((FillPassword)_003F350_003F).Loaded += _003F80_003F;
				break;
			case 2:
			...
			case 6:
				...
				break;
			case 7:
				txtFill = (PasswordBox)_003F350_003F;
