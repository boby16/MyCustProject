...
{
	public class P_AutoNextFillInt : Page, IComponentConnector
	{
		[Serializable]
		[CompilerGenerated]
		...
		private void _003F99_003F(object _003F347_003F, EventArgs _003F348_003F)
		{
			...
			ScrollViewer scrollViewer = ((P_AutoNextFillInt)/*Error near IL_0010: Stack underflow*/).scrollmain;
			if (Button_Type < -20)
			{
		...
		private void _003F135_003F()
		{
			...
			foreach (SurveyDetail qCircleDetail in oQuestion.QCircleDetails)
			{
				...
				if (SurveyHelper.NavOperation == _003F487_003F._003F488_003F("FŢɡ\u036a"))
				{
					...
					text = ((text != null && !(text == _003F487_003F._003F488_003F(""))) ? _003F96_003F(text).ToString() : _003F487_003F._003F488_003F(""));
				}
				WrapPanel wrapPanel2 = new WrapPanel();
				if (!(oQuestion.QCircleDefine.CONTROL_TOOLTIP.Trim().ToUpper() == _003F487_003F._003F488_003F("W")))
				{
				}
				((WrapPanel)/*Error near IL_01c5: Stack underflow*/).Orientation = (Orientation)/*Error near IL_01c5: Stack underflow*/;
					...
					if (/*Error near IL_00f4: Stack underflow*/ > val)
					{
						...
						if (/*Error near IL_0105: Stack underflow*/ > /*Error near IL_0105: Stack underflow*/)
						{
							...
							else
							{
								...
								{
									listFills[num - 1].Focus();
									((P_AutoNextFillInt)/*Error near IL_0073: Stack underflow*/).listTexts[num - 1].BringIntoView();
								}
							}
						}
					}
		...
		private void _003F58_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			if (_003F87_003F())
			{
				...
				string content = ((P_AutoNextFillInt)/*Error near IL_0040: Stack underflow*/).btnNav_Content;
		...
		private void _003F84_003F(object _003F347_003F, EventArgs _003F348_003F)
		{
			...
			{
				timer.Stop();
				((P_AutoNextFillInt)/*Error near IL_0010: Stack underflow*/).btnNav.Foreground = Brushes.Black;
				btnNav.Content = btnNav_Content;
			}
			else
			{
		...
		private void _003F90_003F(object _003F347_003F, RoutedEventArgs _003F348_003F = null)
		{
			...
			{
				List<TextBox> listFill = listFills;
				int nLastTextBox = ((P_AutoNextFillInt)/*Error near IL_00a3: Stack underflow*/)._nLastTextBox;
				if (((List<TextBox>)/*Error near IL_00a8: Stack underflow*/)[nLastTextBox].Text == _003F487_003F._003F488_003F(""))
				{
					...
					{
						((P_AutoNextFillInt)/*Error near IL_00e5: Stack underflow*/).listW[_nLastTextBox].Visibility = Visibility.Collapsed;
						_nLastTextBox--;
					}
				}
			}
		...
		private void _003F91_003F(object _003F347_003F, RoutedEventArgs _003F348_003F = null)
		{
			...
			if (_nLastTextBox < listW.Count - 1)
			{
				...
				if (((List<TextBox>)/*Error near IL_009f: Stack underflow*/)[nLastTextBox].Text != _003F487_003F._003F488_003F(""))
				{
					...
					((P_AutoNextFillInt)/*Error near IL_00bd: Stack underflow*/)._nLastTextBox = (int)/*Error near IL_00bd: Stack underflow*/;
				...
				if (num > 0)
				{
					...
					if ((int)/*Error near IL_0166: Stack underflow*/ == nLastTextBox2)
					{
						...
						{
							int nLastTextBox3 = ((P_AutoNextFillInt)/*Error near IL_010b: Stack underflow*/)._nLastTextBox + 1;
							((P_AutoNextFillInt)/*Error near IL_0112: Stack underflow*/)._nLastTextBox = nLastTextBox3;
							listW[_nLastTextBox].Visibility = Visibility.Visible;
						}
					}
				}
		...
		void IComponentConnector.Connect(int _003F349_003F, object _003F350_003F)
		{
			...
			{
			case 1:
				((P_AutoNextFillInt)_003F350_003F).Loaded += _003F80_003F;
				((P_AutoNextFillInt)_003F350_003F).LayoutUpdated += _003F99_003F;
				break;
			case 2:
