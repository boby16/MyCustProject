...
{
	public class GridMultiple_LoopC_FixCol1 : Page, IComponentConnector
	{
		[Serializable]
		[CompilerGenerated]
		...
		private void _003F28_003F()
		{
			...
			//IL_0466: Incompatible stack heights: 0 vs 1
			//IL_0476: Incompatible stack heights: 0 vs 1
			//IL_0477: Incompatible stack heights: 0 vs 1
			//IL_0771: Incompatible stack heights: 0 vs 1
			//IL_0772: Incompatible stack heights: 0 vs 1
			//IL_08e3: Incompatible stack heights: 0 vs 1
			//IL_08f3: Incompatible stack heights: 0 vs 1
			//IL_08f4: Incompatible stack heights: 0 vs 1
			//IL_09d9: Incompatible stack heights: 0 vs 1
			//IL_09ea: Incompatible stack heights: 0 vs 1
			//IL_09ec: Incompatible stack heights: 0 vs 1
			//IL_0e39: Incompatible stack heights: 0 vs 1
			//IL_0e43: Incompatible stack heights: 0 vs 1
			//IL_0ed8: Incompatible stack heights: 0 vs 1
			//IL_0ee2: Incompatible stack heights: 0 vs 1
			//IL_0fae: Incompatible stack heights: 0 vs 1
			//IL_0fb8: Incompatible stack heights: 0 vs 1
			//IL_11fd: Incompatible stack heights: 0 vs 1
			//IL_120d: Incompatible stack heights: 0 vs 1
			//IL_120e: Incompatible stack heights: 0 vs 1
			...
			if (oQuestion.QDefine.NOTE == _003F487_003F._003F488_003F("") || oQuestion.QCircleDefine.CONTROL_TYPE != 1)
			{
				...
				Thickness borderThickness = new Thickness((double)/*Error near IL_0478: Stack underflow*/);
				((Border)/*Error near IL_0482: Stack underflow*/).BorderThickness = borderThickness;
			}
			Border border = new Border();
			...
			try
			{
				while (enumerator.MoveNext())
				{
					...
					bool flag2 = (byte)/*Error near IL_0774: Stack underflow*/ != 0;
					...
					if ((oQuestion.QCircleDefine.CONTROL_TYPE != 1) | flag2)
					{
						...
						else
						{
							...
							Thickness borderThickness2 = new Thickness((double)/*Error near IL_08f5: Stack underflow*/);
							((Border)/*Error near IL_08ff: Stack underflow*/).BorderThickness = borderThickness2;
							...
							((TextBlock)/*Error near IL_09f1: Stack underflow*/).Text = (string)/*Error near IL_09f1: Stack underflow*/;
								...
								while (enumerator3.MoveNext())
								{
									...
									if (list.Contains(current5.CODE))
									{
										...
										if (CodeOfGroupNone.Contains(_003F487_003F._003F488_003F(".") + current5.IS_OTHER.ToString() + _003F487_003F._003F488_003F(".")))
										{
											...
											string str3 = (string)/*Error near IL_0e45: Stack underflow*/;
										...
										if (!CodeOfNone.Contains(_003F487_003F._003F488_003F(".") + current5.IS_OTHER.ToString() + _003F487_003F._003F488_003F(".")))
										{
											...
											string str4 = (string)/*Error near IL_0ee4: Stack underflow*/;
					...
					try
					{
						while (enumerator3.MoveNext())
						{
							...
							string text5 = (string)/*Error near IL_0fba: Stack underflow*/;
							...
							((FrameworkElement)/*Error near IL_1213: Stack underflow*/).Style = (Style)/*Error near IL_1213: Stack underflow*/;
							if (flag)
							{
								button.Opacity = 0.85;
							}
		...
		private void _003F89_003F(List<VEAnswer> _003F370_003F)
		{
			...
			if (oQuestion.QDefine.PAGE_COUNT_DOWN > 0)
			{
				...
				int pAGE_COUNT_DOWN = ((GridMultiple_LoopC_FixCol1)/*Error near IL_003c: Stack underflow*/).oQuestion.QDefine.PAGE_COUNT_DOWN;
		...
		void IComponentConnector.Connect(int _003F349_003F, object _003F350_003F)
		{
			...
			{
			case 1:
				((GridMultiple_LoopC_FixCol1)_003F350_003F).Loaded += _003F80_003F;
				((GridMultiple_LoopC_FixCol1)_003F350_003F).LayoutUpdated += _003F99_003F;
				break;
			case 2:
