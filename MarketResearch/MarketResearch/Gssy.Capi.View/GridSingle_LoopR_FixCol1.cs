...
{
	public class GridSingle_LoopR_FixCol1 : Page, IComponentConnector
	{
		[Serializable]
		[CompilerGenerated]
		private sealed class _003F7_003F
		{
			...
			public static Comparison<SurveyDetail> _003C_003E9__34_1;
			...
			internal int _003F305_003F(SurveyDetail _003F481_003F, SurveyDetail _003F482_003F)
			{
				return Comparer<int>.Default.Compare(_003F481_003F.INNER_ORDER, _003F482_003F.INNER_ORDER);
			}
		}
		...
		private void _003F80_003F(object _003F347_003F, RoutedEventArgs _003F348_003F)
		{
			...
			//IL_0698: Incompatible stack heights: 0 vs 1
			//IL_0699: Incompatible stack heights: 0 vs 1
			...
			//IL_0b21: Incompatible stack heights: 0 vs 2
			//IL_0b38: Incompatible stack heights: 0 vs 1
			//IL_1030: Incompatible stack heights: 0 vs 2
			//IL_1047: Incompatible stack heights: 0 vs 1
			...
			CL_Width = oFunc.StringToInt(oBoldTitle.AlignmentPara(oQuestion.QDefine.CONTROL_TOOLTIP.ToUpper().Trim(), ref CircleLabel_HorizontalAlignment, ref CircleLabel_VerticalAlignment));
			if (oQuestion.QCircleDefine.CONTROL_TYPE == 0 && oQuestion.QDefine.PARENT_CODE == _003F487_003F._003F488_003F(""))
			{
				bool flag = oQuestion.QDefine.NOTE == _003F487_003F._003F488_003F("");
			}
			if ((int)/*Error near IL_0699: Stack underflow*/ == 0 && oQuestion.QCircleDefine.CONTROL_TYPE == 1)
			{
				bool flag2 = oQuestion.QCircleDefine.PARENT_CODE == _003F487_003F._003F488_003F("");
			}
			...
			if (oQuestion.QDefine.NOTE != _003F487_003F._003F488_003F("") && oQuestion.QCircleDefine.CONTROL_TYPE == 0)
			{
			...
			if (oQuestion.QCircleDefine.LIMIT_LOGIC != _003F487_003F._003F488_003F(""))
			{
				...
				((List<SurveyDetail>)/*Error near IL_0b3d: Stack underflow*/).Sort((Comparison<SurveyDetail>)/*Error near IL_0b3d: Stack underflow*/);
			...
			if (oQuestion.QDefine.LIMIT_LOGIC != _003F487_003F._003F488_003F(""))
			{
				...
				if (_003F7_003F._003C_003E9__34_1 == null)
				{
					_003F7_003F._003C_003E9__34_1 = _003F7_003F._003C_003E9._003F305_003F;
				}
				((List<SurveyDetail>)/*Error near IL_104c: Stack underflow*/).Sort((Comparison<SurveyDetail>)/*Error near IL_104c: Stack underflow*/);
			...
			if (Button_Width < 2.0)
			{
				...
				Button_Width = (num5 - (double)((oQuestion.QDetails.Count - 1) * 4) - 43.0) / (double)oQuestion.QDetails.Count;
		...
		private void _003F99_003F(object _003F347_003F, EventArgs _003F348_003F)
		{
			...
			//IL_0400: Incompatible stack heights: 0 vs 1
			//IL_0410: Incompatible stack heights: 0 vs 1
			...
			//IL_0495: Incompatible stack heights: 0 vs 1
			if (PageLoaded)
			{
				if (GridTopLeft.ActualHeight > 0.0 || GridTopRight.ActualHeight > 0.0)
				{
					...
					{
						double actualHeight = GridTopRight.ActualHeight;
					}
					else
					{
						double actualHeight2 = GridTopLeft.ActualHeight;
					}
				...
				if (oQuestion.QCircleDefine.CONTROL_TYPE == 0 && oQuestion.QDefine.NOTE == _003F487_003F._003F488_003F(""))
				{
					bool flag2 = oQuestion.QDefine.PARENT_CODE != _003F487_003F._003F488_003F("");
				}
				bool flag = (byte)/*Error near IL_016e: Stack underflow*/ != 0;
				...
				if (((/*Error near IL_01b3: Stack underflow*/ | flag) ? 1 : 0) != 0)
				{
					Border borderRight2 = borderRight;
					if (!(TR_Show == _003F487_003F._003F488_003F("1")))
					{
					}
					Thickness borderThickness = new Thickness((double)/*Error near IL_01fe: Stack underflow*/);
					((Border)/*Error near IL_0208: Stack underflow*/).BorderThickness = borderThickness;
					...
					try
					{
						while (enumerator.MoveNext())
						{
							...
							Button button = matixButton.Attributes[0].Buttons[num2];
							...
							else
							{
								...
								Thickness borderThickness2 = new Thickness((double)/*Error near IL_0412: Stack underflow*/);
								((Border)/*Error near IL_041c: Stack underflow*/).BorderThickness = borderThickness2;
								...
								((TextBlock)/*Error near IL_049a: Stack underflow*/).Text = (string)/*Error near IL_049a: Stack underflow*/;
								textBlock.Style = (Style)FindResource(_003F487_003F._003F488_003F("Qžɾͻѫգٸ\u0746\u086f७\u0a61୲౫\u0d56\u0e70\u0f7aၮᅤ"));
								textBlock.Foreground = (Brush)FindResource(_003F487_003F._003F488_003F("\\Źɯ\u037aѻբ٢\u0747\u0876ॶ\u0a71୩"));
								textBlock.TextWrapping = TextWrapping.Wrap;
				...
				if (OthButtonStartCol > 0 && oQuestion.QCircleDefine.CONTROL_TYPE == 0 && oQuestion.QDefine.NOTE != _003F487_003F._003F488_003F(""))
				{
					double num5 = 0.0;
					Grid gridBottomRight3 = GridBottomRight;
					for (int i = OthButtonStartCol; i < gridBottomRight3.ColumnDefinitions.Count(); i++)
					{
						num5 += gridBottomRight3.ColumnDefinitions[i].ActualWidth;
					}
					GridTopRight.Width = GridBottomRight.ActualWidth - num5;
				}
		...
		{
			//IL_042c: Incompatible stack heights: 0 vs 1
			//IL_042d: Incompatible stack heights: 0 vs 1
			//IL_0667: Incompatible stack heights: 0 vs 1
			//IL_0678: Incompatible stack heights: 0 vs 1
			//IL_067a: Incompatible stack heights: 0 vs 1
			//IL_0b32: Incompatible stack heights: 0 vs 1
			//IL_0b42: Incompatible stack heights: 0 vs 1
			//IL_0b43: Incompatible stack heights: 0 vs 1
			...
			foreach (SurveyDetail qCircleDetail in oQuestion.QCircleDetails)
			{
				...
				if (oQuestion.QCircleDefine.CONTROL_TYPE == 1)
				{
					bool flag3 = oQuestion.QCircleDefine.PARENT_CODE != _003F487_003F._003F488_003F("");
				}
				bool flag2 = (byte)/*Error near IL_042f: Stack underflow*/ != 0;
				List<SurveyDetail>.Enumerator enumerator2;
				if ((oQuestion.QCircleDefine.CONTROL_TYPE != 1) | flag2)
				{
					...
					else
					{
						...
						((TextBlock)/*Error near IL_067f: Stack underflow*/).Text = (string)/*Error near IL_067f: Stack underflow*/;
						textBlock.Style = style3;
						textBlock.Foreground = foreground;
						textBlock.TextWrapping = TextWrapping.Wrap;
						textBlock.Margin = new Thickness(5.0, 0.0, 5.0, 0.0);
						textBlock.HorizontalAlignment = CircleLabel_HorizontalAlignment;
						textBlock.VerticalAlignment = CircleLabel_VerticalAlignment;
						if (oQuestion.QCircleDefine.CONTROL_FONTSIZE > 0)
						{
							textBlock.FontSize = (double)oQuestion.QCircleDefine.CONTROL_FONTSIZE;
						}
				...
				border.SetValue(Grid.ColumnSpanProperty, oQuestion.QDetails.Count);
				...
				try
				{
					...
					{
						SurveyDetail current3 = enumerator2.Current;
						if (OthButtonStartCol == 0 && current3.IS_OTHER > 0)
						{
							OthButtonStartCol = num5;
						}
						...
						((FrameworkElement)/*Error near IL_0b48: Stack underflow*/).Style = (Style)/*Error near IL_0b48: Stack underflow*/;
						if (flag)
						{
							button.Opacity = 0.85;
						}
		...
		private bool _003F87_003F()
		{
			...
			try
			{
				while (enumerator.MoveNext())
				{
					if (enumerator.Current == _003F487_003F._003F488_003F("") && GridBottomRight.RowDefinitions[num].ActualHeight > 3.0)
					{
		...
		private void _003F89_003F(List<VEAnswer> _003F370_003F)
		{
			...
			{
				((GridSingle_LoopR_FixCol1)/*Error near IL_003c: Stack underflow*/).oPageNav.PageDataLog(oQuestion.QDefine.PAGE_COUNT_DOWN, _003F370_003F, btnNav, MySurveyId);
			}
		}
		...
		private void _003F84_003F(object _003F347_003F, EventArgs _003F348_003F)
		{
			...
			{
				((GridSingle_LoopR_FixCol1)/*Error near IL_0010: Stack underflow*/).timer.Stop();
		...
		void IComponentConnector.Connect(int _003F349_003F, object _003F350_003F)
		{
			...
			{
			case 1:
				((GridSingle_LoopR_FixCol1)_003F350_003F).Loaded += _003F80_003F;
				((GridSingle_LoopR_FixCol1)_003F350_003F).LayoutUpdated += _003F99_003F;
				break;
			case 2:
