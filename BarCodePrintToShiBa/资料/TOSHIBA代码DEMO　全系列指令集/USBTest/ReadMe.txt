========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : USBTest
========================================================================


AppWizard が生成した USBTest には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには USBTest を構成している各ファイルの概要説明が含まれています。
...
USBTest.h
    ...
    みます） をインクルードし、また CUSBTestApp アプリケーションクラスを宣
    言します。

USBTest.cpp
    このファイルは CUSBTestApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\USBTest.ico
    ...
    ルです。このアイコンはリソース ファイル USBTest.rc によってインクルード
    されます。
...
USBTestDlg.h, USBTestDlg.cpp - ダイアログ
    これらのファイルは CUSBTestDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な USBTest.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) USBTest.pch 
